...
;(function(window, undefined) {
   ...
   * build and using precompiled tpl, or loading Lo-Dash in a sandbox.
   *
   * For more information on precompiling tpl see:
   ...
   * }
   *
   * // using the `source` property to inline compiled tpl for meaningful
  ...
  function template(text, data, options) {
    ...
    // inlining compiled tpl during the build process
